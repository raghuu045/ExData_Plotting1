...
par(mfrow=c(2,2)) ## loads the plots row-wise

plot(data$data_timestamp,data$Global_active_power,type="l",
     ylab="Global Active Power",xlab="")

plot(data$data_timestamp,data$Voltage,type="l",ylab="Voltage",
     xlab="datetime")

plot(data$data_timestamp,data$Sub_metering_1,type="n",xlab="",
     ylab="Energy sub metering")
points(data$data_timestamp,data$Sub_metering_1,type="l",col="black")
points(data$data_timestamp,data$Sub_metering_2,type="l",col="red")
points(data$data_timestamp,data$Sub_metering_3,type="l",col="blue")
legend("topright",lty=c("solid","solid","solid"),
       col=c("black","red","blue"),
       legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),
       cex=.85)

plot(data$data_timestamp,data$Global_reactive_power,type="l",
